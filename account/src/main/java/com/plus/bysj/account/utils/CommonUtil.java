...
public final class CommonUtil {
    ...
    public static String dateFormat(Date dateStr) {
        SimpleDateFormat mt = new SimpleDateFormat("yyyyMMddHHmmss");
        return mt.format(dateStr);
    }

    public static String Md5(String dateStr) {
        return DigestUtils.md5DigestAsHex(dateStr.getBytes(StandardCharsets.UTF_8));
    }
