    ...
    <div class="home">
        ...
        <div class="banner">
            <div style="float:left;margin-left:200px;position:absolute;z-index:999">
                <p style="color:red;margin-top:40px;font-size:40px">It's easy and fast!</p>
                <div style="color:red;margin-top:40px;font-size:40px">To achieve quick transfer and billing</div>
            </div>
            <el-carousel loop>
                <el-carousel-item>
...
export default {
  ...
  methods: {
        changeTab(key) {
            this.activeSpan = key;
            if (
                (this.activeSpan != "openAcount"&&this.activeSpan != "login") &&
